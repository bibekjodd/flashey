...
export default function Search() {
  ...
  return (
    <section className="relative pb-3 focus:outline-none">
      ...
      {query && (
        <div className="absolute top-full z-20 mt-2 w-full space-y-1 rounded-lg border bg-white/80 p-2 py-4 filter backdrop-blur-md dark:border-white/30 dark:bg-gray-900">
          ...
          {searchResults.map((result) => {
            ...
            return (
              <Link
                ...
                href={chatLink}
                key={result.id}
                className="flex items-center space-x-2 rounded-md p-2 text-sm font-medium hover:bg-neutral-100 dark:bg-gray-700/20 dark:hover:bg-gray-700/40"
              >
